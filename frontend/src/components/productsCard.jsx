...
export default function ProductsCard({ product }) {
  ...
  return (
    <Link
      ...
      className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full block"
    >
          ...
          <div className="text-primary">
            {!cartItem ? (
              ...
              >
                ...
                <button
                  onClick={() => updateCart(product._id, cartItem.quantity + 1)}
                  className="cursor-pointer text-md px-2 h-full"
                >
                  +
                </button>
